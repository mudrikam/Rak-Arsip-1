...
set "vars=programReset menu_Type isType isUser isClient rootFolder mainCategory subCategory userCategoryChoice userSubCategoryChoice validCategoryChoice validSubCategoryChoice projectType isLoginUser isSelectedClient projectDate projectName generateProjectDir assetGenerateDir assetFolders main_Project_Type nav_ProjectType" 
