...
REM Tawarkan untuk membuka File Explorer ke folder tersebut
set /p open_explorer=Apakah Anda ingin membuka File Explorer ke folder ini? (y/n): 
...
set "fileConfig=Z:\DSNA_FOLDER_GENERATOR\v1.2.0\config.txt"
...
echo Team Member: !teamMemberName!
echo Client Member: !clientMemberName!
pause
...
if "!projectType!"=="Single" (
    set "naming_TemplateFile=!singleProjectName!\%projectDate%_%inputFolderName%_%projectTypeSingle%_00%counter%.txt"
) else (
